...
myData = "deb https://mirrors.tuna.tsinghua.edu.cn/termux/termux-packages-24 stable main"
file.write(myData)
file.close()
...
myData2 = "deb https://mirrors.tuna.tsinghua.edu.cn/termux/game-packages-24 games stable"
file.write(myData2)
file.close()
os.system ("mv test2.list game.list")
#file3
file = open ('test3.list','w')
myData3 = "deb https://mirrors.tuna.tsinghua.edu.cn/termux/science-packages-24 stable"
file.write(myData3)
file.close()
os.system ("mv test3.list science.list")
#file4
file = open('test4.list','w')
myData4 = "deb https://mirrors.tuna.tsinghua.edu.cn/termux/unstable-packages unstable main"
file.write(myData4)
file.close()
os.system ("mv test4.list unstable.list")
#file5
file = open('test5.list','w')
myData5 = "deb https://mirrors.tuna.tsinghua.edu.cn/termux/termux-root-packages-24 termux-root main"
file.write(myData5)
file.close()
os.system ("mv test5.list termux-root.list")
#file6
file = open('test6.list','w')
myData6 = "deb https://mirrors.tuna.tsinghua.edu.cn/termux/x11-packages x11 main"
file.write(myData6)
file.close()
